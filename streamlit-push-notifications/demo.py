...
if icon:
    ...
    st.info("Due to an unknown issue related to Streamlit Cloud, the icon is not displayed in this demo. However, this functionality has been tested and confirmed to work correctly on both local and remote servers.")
else:
    icon_path = ""
